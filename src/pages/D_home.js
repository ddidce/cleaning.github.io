        ...
        <div id="inner_hom">
            ...
            <div className="con_img_hom">
                <div className="img_text_hom">
                    <span className="img_text_tit_hom"> 프로젝트에서 제공하는 특별한 청소!</span><br/>
                    ...
                    <div className="flex_contents_hom">
                        <div className="flex_contents_box">
                            <img src={premium_img01} className="img1_hom" alt="pre1"/><br/>
                            <span className="flex_contents_txt_hom">PROFESSIONAL SERVICE</span>
                        </div>
                        <div className="flex_contents_box">
                            <img src={premium_img02} className="img2_hom" alt="pre1"/><br/>
                            <span className="flex_contents_txt_hom">PROMISE TO CUSTMOER</span>
                        </div>
                        <div className="flex_contents_box">
                            <img src={premium_img03} className="img3_hom" alt="pre1"/><br/>
                            <span className="flex_contents_txt_hom">PERFECT CLEANING</span>
                        </div>
                        <br/>
                    </div>
                    <div className="flex_contents2_hom">
                        <div className="flex_contents_box2">
                            <div className="png_box_hom">
                                <img src={premium_icon01} className="png1_hom" alt="pre1"/><br/>
                            </div>
                            <span className="flex_contents_txt_hom2">오염방지 코팅 <br/>서비스</span>
                        </div>
                        <div className="flex_contents_box2">
                            <div className="png_box_hom">
                                <img src={premium_icon02} className="png2_hom"alt="pre1"/><br/>
                            </div>
                            <span className="flex_contents_txt_hom2">스팀살균청소</span>
                        </div>
                        <div className="flex_contents_box2">
                            <div className="png_box_hom">
                                <img src={premium_icon03} className="png3_hom" alt="pre1"/><br/>
                            </div>
                            <span className="flex_contents_txt_hom2">친환경 청소</span>
                        </div>
                        <div className="flex_contents_box2">
                            <div className="png_box_hom">
                                <img src={premium_icon04} className="png4_hom" alt="pre1" /><br/>
                            </div>
                            <span className="flex_contents_txt_hom2">꼼꼼함이 돋보이는<br/> 서비스 용도별</span>
                        </div>
                    </div>    
                </div>
                    <div className="intro_b_hom"/>
                        <div className="intro_hom">
                            ...
                            <p className="p_hom">
                                주거시설 청소란 거주하면서 발생한 각종 미세먼지, 찌든 때, 기름때뿐만 아니라<br/>
                                평소 청소하기 어려운 부분과 구석진 곳의 각종 오염물질 및 세균, 곰팡이 부분까지<br/>
                                청소, 살균 소독하여 쾌적하고 청결한 주거 환경을 유지시켜주는 청소입니다.<br/>
                                특히, 노약자나 신생아 등이 있는 가정에 꼭 필요한 서비스입니다.
                            </p>
                        </div>
                <div className="flex_contents3_hom">
                    <h2 className="tit_hom">청소범위</h2>
                        ...
                        <ul className="list_1_hom">
                            ...
                            <li><img src={cleaning_range01} alt="거실" className="list_img1_hom"/></li>
                        </ul>   
                        ...
                        <ul className="list_1">
                            ...
                            <li>인체에 무해한 천연세제 사용 (프리미엄 청소)</li>
                            <li><img src={cleaning_range02} alt="화장실" className="list_img2_hom"/></li>
                        </ul>
                        ...
                        <ul className="list_1">
                            ...
                            <li>하자 체크리스트 제공 (프리미엄 청소)</li>
                            <li>인체에 무해한 천연세제 사용 (프리미엄 청소)</li>
                            <li><img src={cleaning_range03} alt="주방" className="list_img3_hom"/></li>
                        </ul>
                        ...
                        <ul className="list_1">
                            ...
                            <li>하자 체크 리스트 제공 (프리미엄 청소)</li>
                            <li>인체에 무해한 천연세제 사용 (프리미엄 청소)</li>
                            <li><img src={cleaning_range04} alt="베란다" className="list_img4_hom"/></li>
                        </ul>
                </div>
                        <div className="con_img2_hom">
                            <h2 className="h2_hom">서비스 프로세스</h2>
                            <img src={cleaning_process} alt="서비스 프로세스" className="serv_1_hom"/>
                            <div className="serv_2_hom">
                                ...
                                <p className="fd_1_hom"> -평균 청소시간은 6-7시간 소요<br/>

                ...
                <h2 className="h2_edu">교육시설</h2>
                    <div className="con_img_edu">
                        <div className="img_text_edu">
                            <span className="img_text_tit_edu"> 프로젝트에서 제공하는 특별한 청소! </span><br/>
                            ...
                            <span>프로젝트 마스터가 기본청소에 오염방지 코팅서비스, 스팀 살균 청소,<br/>
                                ...
                                <br/>Premium 서비스 신청으로 차별화된 고품질의 서비스를 느껴보세요~
                            </span>
                            <br/>
                        </div>
                            <div className="flex_contents_edu">
                                <div className="flex_contents_box">
                                    <img src={premium_img01} className="img1_edu" alt="pre"/><br/>
                                    <span className="flex_contents_txt_edu">PROFESSIONAL SERVICE</span>
                                </div>
                                <div className="flex_contents_box">
                                    <img src={premium_img02} className="img2_edu" alt="pre"/><br/>
                                    <span className="flex_contents_txt_edu">PROMISE TO CUSTMOER</span>
                                </div>
                                <div className="flex_contents_box">
                                    <img src={premium_img03} className="img3_edu" alt="pre"/><br/>
                                    <span className="flex_contents_txt_edu">PERFECT CLEANING</span>
                                </div>
                                <br/>
                            </div>
                            <div className="flex_contents2_edu">
                                <div className="flex_contents_box2">
                                    <div className="png_box_edu">
                                        <img src={premium_icon01} className="png1_edu" alt=""/><br/>
                                    </div>
                                    <span className="flex_contents_txt_edu2">오염방지 코팅 <br/>서비스</span>
                                </div>
                                <div className="flex_contents_box2">
                                    <div className="png_box_edu">
                                        <img src={premium_icon02} className="png2_edu"  alt=""/><br/>
                                    </div>
                                    <span className="flex_contents_txt_edu2">스팀살균청소</span>
                                </div>
                                <div className="flex_contents_box2">
                                    <div className="png_box_edu">
                                        <img src={premium_icon03} className="png3_edu"  alt=""/><br/>
                                    </div>
                                    <span className="flex_contents_txt_edu2">친환경 청소</span>
                                </div>
                                <div className="flex_contents_box2">
                                    <div className="png_box_edu">
                                        <img src={premium_icon04} className="png4_edu"  alt=""/><br/>
                                    </div>
                                    <span className="flex_contents_txt_edu2">꼼꼼함이 돋보이는<br/> 서비스 용도별</span>
                                </div>
                            </div>
                    </div>
                            <div className="intro_b_edu"/>
                                <div className="intro_edu">
                                    ...
                                    <p className="p_edu">
                                        교육시설 청소란 생활하면서 발생한 각종 미세먼지, 세균뿐만 아니라<br/>
                                        평소 청소하기 어려운 부분과 구석진 곳의 각종 오염물질 및 세균, 곰팡이 부분까지<br/>
                                        청소, 살균 소독하여 쾌적하고 청결한 교육 환경을 유지시켜주는 청소입니다.<br/>
                                        학생들이 오랜시간 머무는 교육시설 청소는 꼭 필요한 서비스입니다.<br/> 
                                        프로젝트의 교육시설 청소는 걱정없는 깨끗한 교육시설을 만들어 드립니다.
                                    </p>
                                </div>
                        <div className="flex_contents3_edu">
                            <h2 className="tit_edu">청소범위</h2>
                                ...
                                <ul className="list_1_edu">
                                    ...
                                    <li><img src={classroom} alt="교실" className="list_img1_edu"/></li>
                                </ul>   
                                ...
                                <ul className="list_1_edu">
                                    ...
                                    <li>구역별 전용 걸레 사용 (프리미엄 청소)</li>
                                    <li>인체에 무해한 천연세제 사용 (프리미엄 청소)</li>
                                    <li><img src={schooltoilet} alt="화장실" className="list_img2_edu"/></li>
                                </ul>
                                ...
                                <ul className="list_1_edu">
                                    ...
                                    <li>구역별 전용 걸레 사용 (프리미엄 청소)</li>
                                    <li>인체에 무해한 천연세제 사용 (프리미엄 청소)</li>
                                    <li><img src={schoolcook} alt="급식실/조리실" className="list_img3_edu"/></li>
                                </ul>
                                ...
                                <ul className="list_1_edu">
                                    ...
                                    <li>인체에 무해한 천연세제 사용 (프리미엄 청소)</li>
                                    <li><img src={schoolbuilding} alt="학교외부" className="list_img4_edu"/></li>
                                </ul>
                        </div>
                                <div className="con_img2_edu">
                                    <h2 className="h2_edu">서비스 프로세스</h2>
                                    <img src={cleaning_process} alt="서비스 프로세스" className="serv_1_edu"/>
                                    <div className="serv_2_edu">
                                        ...
                                        <p className="fd_1_edu"> -평균 청소시간은 6-7시간 소요<br/>

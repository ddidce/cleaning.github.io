    ...
    <div className="warp">
        ...
        <div className ="choose">  
            ...
            <div className ="choose2">
                <span className ="background" id="tit">청소 날짜 선택*</span>
                <input type="date" className="date"/>
            </div>
            <div className ="choose2">
                <span className ="background" id="tit" >작업현장 주소*</span>
                        <select id="addr_box">
                    ...
                    <input type="text" placeholder="상세주소" id="addr_text"></input> 
            </div>
            <div className ="choose2">
            ...
            <div className ="choose2">
                ...
                <input type="tel" maxlength="11" placeholder="숫자만 입력해주세요"/>
            </div>
            <div className ="choose2"> 
                <form>
            ...
            <div className="choose2">
                ...
                <textarea className="txt-area" rows="8" cols="35" placeholder="추가요청사항을 기재해주세요"/>
                <p className="textarea-p">자세한 사항은 고객센터(1877-0000)에 문의하시기 바랍니다.</p>
            </div>
            
            <div className ="agree"><br/>개인정보 수집 및 이용동의(필수)</div>
            <div className ="data_box">
                <div className ="data">
                <p className ="txt">('www.project.co.kr'이하 '프로젝트관리서비스(주)')은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.	<br/>		<br/>
                    ('프로젝트관리서비스(주)') 은(는) 회사는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.			<br/>
                    <br/>
                    ○ 본 방침은부터 2019년 10월 20일부터 시행됩니다.</p>
                ...
                <p className ="txt"> ('www.project.co.kr''이하 '프로젝트관리서비스(주)')은(는) 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.<br/>
                    가. 홈페이지 회원가입 및 관리			<br/>
                ...
                <p className ="txt">① ('프로젝트관리서비스(주)')은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집시에 동의 받은 개인정보 보유,이용기간 내에서 개인정보를 처리,보유합니다.			<br/>
                ...
                <p className ="txt">
                    ① 정보주체는 프로젝트관리서비스(주)에 대해 언제든지 개인정보 열람,정정,삭제,처리정지 요구 등의 권리를 행사할 수 있습니다.			<br/>
                    ② 제1항에 따른 권리 행사는프로젝트관리서비스(주)에 대해 개인정보 보호법 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 프로젝트관리서비스(주)은(는) 이에 대해 지체 없이 조치하겠습니다.			<br/>
                    ③ 제1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우 개인정보 보호법 시행규칙 별지 제11호 서식에 따른 위임장을 제출하셔야 합니다.			<br/>
                    ④ 개인정보 열람 및 처리정지 요구는 개인정보보호법 제35조 제5항, 제37조 제2항에 의하여 정보주체의 권리가 제한 될 수 있습니다.			<br/>
                    ⑤ 개인정보의 정정 및 삭제 요구는 다른 법령에서 그 개인정보가 수집 대상으로 명시되어 있는 경우에는 그 삭제를 요구할 수 없습니다.			<br/>
                    ⑥ 프로젝트관리서비스(주)은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.			
                </p>



                <p className ="sub_tit">5. 처리하는 개인정보의 항목 작성 </p>
                <p className ="txt">① ('www.project.co.kr''이하 '프로젝트관리서비스(주)')은(는) 다음의 개인정보 항목을 처리하고 있습니다.		<br/>	
                            <br/>
                ...
                <p className ="sub_tit">6. 개인정보의 파기('프로젝트관리서비스(주)')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.			</p>
                ...
                <p className ="txt">프로젝트관리서비스(주) 은 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키’를 사용하지 않습니다.</p>
                ...
                <p className ="txt">① 프로젝트관리서비스(주)(‘www.project.co.kr'’이하 ‘프로젝트관리서비스(주)) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.		<br/>	
                    ▶ 개인정보 보호책임자			<br/>
                    성명 : Project<br/>
                    직급 : 대표<br/>
                    연락처 : 1877-3855<br/>
                    ② 정보주체께서는 프로젝트관리서비스(주)(‘www.project.co.kr'’이하 ‘프로젝트관리서비스(주)) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 프로젝트관리서비스(주)(‘www.project.co.kr'’이하 ‘프로젝트관리서비스(주)) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.			
                </p>
                ...
                <p className ="sub_tit">10. 개인정보의 안전성 확보 조치 ('프로젝트관리서비스(주)')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.</p>
